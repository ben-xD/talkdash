...
import {password, setPassword, setUsername, username} from "../user/userState.ts";
...
export const MetadataView = () => {
  return <div class='py-4 my-2 p-4 rounded-xl gap-2 flex flex-col gap-4'>
    <div class='flex gap-2'><span
      class='font-bold'>Elapsed:</span><span>{elapsedTime().hours}:{elapsedTime().minutes}:{elapsedTime().seconds}</span>
    </div>
