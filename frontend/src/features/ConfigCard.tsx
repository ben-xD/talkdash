...
export function ConfigCard() {
  ...
  return <div class='flex flex-col items-start gap-8 text-cyan-800 z-10 relative'>
    <div class='flex flex-col gap-2 items-start'>
      <label class="whitespace-normal break-words" for='finishTime'>Talk length (minutes)*</label>
      <input required placeholder='20.5' autofocus class='bg-blue-200 rounded-lg px-2 w-full' type='text' id='finishTime'
